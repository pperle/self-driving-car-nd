...
## The Model
### State
The MPC uses a simple kinematic model without dynamic forces.

![state-model](./img/vehicle_state_model.png)
 - x and y position of the vehicle
 - ψ orientation of the vehicle with respect to the center lane
 - v velocity of the vehicle

### Actuators
The MPC output two values.
 - δ steering angle
 - a acceleration

### Update equations
The MPC predicts the resulting trajectory and selects the trajectory with the lowest/minimal cost.
Predictios are based on the current state and the actuators.
